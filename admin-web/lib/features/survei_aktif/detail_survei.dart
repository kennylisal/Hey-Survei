...
class _DetailSurveiState extends ConsumerState<DetailSurvei> {
  ...
  void initState() {
    Future(() async {
      ...
      surveiTemp = await SurveikuController().getSurveiData(idSurvei);
      print("ini nilai surveitemp -> $surveiTemp");
      final idUser = idUserAdmin;
    ...
    return Column(
      children: [
        (surveiTemp != null)
            ...
            : LoadingBiasa(text: "Memuat Data Survei")
      ],
    );
  }
}
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  CurrencyFormat.convertToIdr(dataSurvei.headerSurvei.harga, 2),
                  style: Theme.of(context).textTheme.titleLarge!.copyWith(
                      fontSize: 36,
                      color: Colors.black,
                      fontWeight: FontWeight.bold),
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (dataSurvei.headerSurvei.isKlasik) {
                            context.goNamed(RouterConstant.previewKlasik,
                                pathParameters: {
                                  'idForm': dataSurvei.detailSurvei.idForm
                                });
                          } else {
                            context.goNamed(RouterConstant.previewKartu,
                                pathParameters: {
                                  'idForm': dataSurvei.detailSurvei.idForm
                                });
                          }
                  ...
                  Column(
                    children: [
                      Container(
                          ...
                          child: ElevatedButton(
                              onPressed: () async {
                                // await KatalogController().masukkanCart(
                                //     dataSurvei.headerSurvei.id_survei, context);
                              },
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Colors.blue.shade900,
                                shape: RoundedRectangleBorder(
