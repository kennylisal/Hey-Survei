...
class TemplateForm {
  ...
  factory TemplateForm.fromMap(Map<String, dynamic> map) {
    return TemplateForm(
  ...
  factory TemplateForm.fromJson(String source) =>
      TemplateForm.fromMap(json.decode(source) as Map<String, dynamic>);
}
