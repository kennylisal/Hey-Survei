...
enum HalamanForm { halamanForm, halamanBerhasilTemplate }
...
class FormStateX {
  ...
  FormStateX({
    ...
    this.indexCabang = 0,
    this.indexUtama = 0,
    this.halamanForm = HalamanForm.halamanForm,
  });
  ...
  FormStateX copyWith({
    ...
    return FormStateX(
      ...
      halamanForm: halamanForm ?? this.halamanForm,
    );
  }
  ...
  Map<String, dynamic> formToTemplateKartu(String kategori) {
    return <String, dynamic>{
      'judul': controllerJudul.text,
      'petunjuk': controllerPetunjuk.text,
      'daftarSoal': getDataForm(TipePertanyaan.pertanyaanKartu),
  ...
  Map<String, dynamic> formToTemplateKlasik(String kategori) {
    return <String, dynamic>{
      'judul': controllerJudul.text,
