...
import 'package:aplikasi_admin/features/formV2/percobaan_drag.dart';
...
class _SidebarKartuState extends ConsumerState<SideBarKartu> {
  ...
  buatTemplate() async {
    ...
    bool hasil = await widget.formController
        .buatTemplateKartu(context, controllerKategori.text);
    if (hasil) {
...
class KolomBuatTemplate extends StatefulWidget {
  KolomBuatTemplate({
    super.key,
    required this.controllerKategori,
    required this.controller,
  });
  TextEditingController controllerKategori;
  FormController controller;
  @override
  State<KolomBuatTemplate> createState() => _KolomBuatTemplateState();
}

class _KolomBuatTemplateState extends State<KolomBuatTemplate> {
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  margin: const EdgeInsets.symmetric(vertical: 6),
                  child: TextField(
                    controller: widget.controllerKategori,
                    decoration: InputDecoration(
                      hintStyle: Theme.of(context)
                          .textTheme
                          .titleLarge!
