...
import 'package:aplikasi_admin/features/laporan/laporan_klasik/laporan_controller.dart';
import 'package:aplikasi_admin/features/laporan/laporan_klasik/laporan_page_controller.dart';
import 'package:aplikasi_admin/features/laporan/laporan_klasik/laporan_services.dart';
import 'package:aplikasi_admin/features/laporan/laporan_util.dart';
import 'package:aplikasi_admin/features/laporan/models/laporan_survei_klasik.dart';
import 'package:aplikasi_admin/features/laporan/state/data_kumpulan_jawaban.dart';
import 'package:aplikasi_admin/features/laporan/state/laporan_klasik_controller.dart';
...
import 'package:aplikasi_admin/features/laporan/widgets/container_soal_satuan.dart';
import 'package:aplikasi_admin/features/laporan/widgets/container_utama_soal.dart';
import 'package:aplikasi_admin/features/laporan/widgets/komponen_tab_search.dart';
import 'package:aplikasi_admin/features/laporan/widgets/pembatas_cabang.dart';
import 'package:aplikasi_admin/features/laporan/widgets/pembatas_soal.dart';
...
class _HalamanLaporanState extends ConsumerState<HalamanLaporanKlasik> {
  ...
  LaporanUtamaKlasikController?
      laporanCabangController; //ini untuk laporan data gabungan
  ...
  List<Widget> generateKonten() {
    if (laporanUtamaController == null) {
      return [
        LoadingBiasa(text: "Memuat Data Laporan"),
      ];
    } else {
        ...
        if (controllerHalaman.getPage() == PagePilihan.halamanUtama) {
          ...
          return [
                ...
                return ContainerUtamaPresentaseLaporan(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      // print(soalUtamaPilihan!
                      //     .pertanyaanKlasik.quillController.document
                      //     .toPlainText());
                    });
                  },
                );
            ...
            ...List.generate(laporanCabangController!.getLength(), (index) {
              return ContainerUtamaPresentaseLaporan(
                  dataPertanyaan: laporanCabangController!
                      .getList()[index]
                      .pertanyaanKlasik,
                  jawaban:
