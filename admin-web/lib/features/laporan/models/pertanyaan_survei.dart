...
class PertanyaanKartu {
  ...
  @override
  String toString() {
    return 'PertanyaanKartu(quillController: $quillController, urlGambar: $urlGambar, modelPertanyaan: $modelPertanyaan, isWajib: $isWajib, showOpsiLainnya: $showOpsiLainnya, idSoal: $idSoal, dataSoal: $dataSoal)';
  }
}
