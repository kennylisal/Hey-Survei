...
class LaporanDataKartuController {
  Map<String, dynamic> mapforCharts(
    ...
    if (dataSoal.tipeSoal == "Pilihan Ganda" ||
      ...
      // print("ini id Pilgan yang didapat -> ${dataPilgan.idSoal}");
      // print("ini mapJawaban yang didapat -> $mapJawaban");
      for (var data in dataPilgan.listJawaban) {
        // print(
        //     "ini yang ditambah ke map ${data.text} / ${data.idData} => ${mapJawaban[data.idData]}");
      ...
      Map<String, dynamic> temp = {};
      // print("ini id GG yang didapat -> ${dataGambarGanda.idSoal}");
      for (var data in dataGambarGanda.listDataGambar) {
        // print(
        //     "ini yang ditambah ke map ${data.urlGambar} / ${data.idData} => ${mapJawaban[data.idData]}");
