//controller atur data mau diapakan di ini screen
//service lebih kearah mengolah data dari DB dan proses pengolahan pas diterima dll

import 'package:flutter/material.dart';
import 'package:hei_survei/features/laporan/chart_widgets/donut_chart.dart';
import 'package:hei_survei/features/laporan/chart_widgets/funnel_chart.dart';
import 'package:hei_survei/features/laporan/chart_widgets/histogram.dart';
import 'package:hei_survei/features/laporan/chart_widgets/line_chart.dart';
import 'package:hei_survei/features/laporan/chart_widgets/pie_chart.dart';
import 'package:hei_survei/features/laporan/chart_widgets/pyramid_chart.dart';
import 'package:hei_survei/features/laporan/chart_widgets/tabel_jawaban.dart';
import 'package:hei_survei/features/laporan/constanst.dart';
import 'package:hei_survei/features/laporan/models/chart_angka_1.dart';
...
class LaporanDataKlasikController {
  Widget generateChart(Map<String, dynamic> mapJawaban, TipeCharts tipeCharts,
    ...
    //diatas untuk slider angka
      ...
      print("betul masuk disini");
      final chartData = generateChartEmailJawaban(mapJawaban);
      print("berhasil bikin chart data");
  ...
  Map<String, dynamic> mapforCharts(
    ...
    if (dataSoal.tipeSoal == "Pilihan Ganda" ||
      ...
      if (dataPilgan.lainnya) {
        temp['Lainnya'] = mapJawaban['Lainnya-xyz'];
      }
      return temp;
  ...
  Map<String, String> generateChartEmailJawaban(
      Map<String, dynamic> mapJawaban) {
    // Map<String, String> hasil = Map.from(mapJawaban);
  ...
  TipeCharts penentuanChartAwal(String tipeSoal) {
    bool legendaBergambar =
        (tipeSoal == "Gambar Ganda" || tipeSoal == "Carousel");
    //dibawah proses penentuan
